...
const Index = () => {
  ...
  return (
    <div className="flex justify-center h-[60vh] py-6">
      <div>
        <div
          onClick={() => setIsList(!isList)}
          className="cursor-pointer w-52 p-4 shadow rounded bg-white text-sm font-medium leading-none text-gray-800 flex items-center justify-between"
        >
          Select Location(s)
          <div>
            {isList ? (
        ...
        {isList && (
          <div className="w-52 mt-2 p-4 bg-white shadow rounded">
            ...
            <button className="focus:outline-none text-xs bg-indigo-100 hover:bg-indigo-200 rounded-md mt-4 font-medium py-2 w-full leading-3 text-indigo-700">
              Apply
            </button>
          </div>
        )}
