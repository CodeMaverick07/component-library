          ...
          <div className="flex flex-wrap">
            <div className="xl:w-1/4 w-full lg:w-1/4 py-5 bg-gray-100 dark:bg-gray-700 px-12 relative border-gray-500 border-r rounded-tl">
              ...
              <ul className="mt-20">
                <li className="flex items-center sm:mb-16 mb-12 cursor-pointer">
                  ...
                  <p className="text-indigo-700 dark:text-indigo-600 text-lg font-normal ml-4">
                    Onboarding
                  </p>
                </li>
                <li className="flex items-center sm:mb-16 mb-12 cursor-pointer">
                  <div className="h-8 flex items-center justify-center border-indigo-700 dark:border-indigo-600 font-bold text-indigo-700 dark:text-indigo-600 w-8 rounded-full border">
                    2
                  </div>
                  <p className="text-gray-800 dark:text-gray-100 text-lg font-normal ml-4">
                    Profile
                  </p>
                </li>
                <li className="flex items-center sm:mb-16 mb-12 cursor-pointer">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-lg font-normal ml-4">
                    Preferences
                  </p>
                </li>
            ...
            <div className="xl:w-3/4 w-full lg:w-3/4">
              ...
              <div className="w-11/12 mx-auto">
                <div className="xl:w-9/12 mx-auto xl:mx-0">
                  <div className="rounded relative h-48">
                    <img
                      src="https://cdn.tuk.dev/assets/photo-1472289065668-ce650ac443d2.jfif"
                      alt
                      className="w-full h-full object-cover overflow-hidden rounded absolute shadow"
                    />
                    ...
                    <div className="w-20 h-20 rounded-full bg-cover bg-center bg-no-repeat absolute bottom-0 -mb-10 ml-12 shadow">
                      <img
                        src="https://tuk-cdn.s3.amazonaws.com/assets/components/form_layouts/fl_2.png"
                        alt
                  ...
                  <div className="mt-16 flex flex-col xl:w-3/6 lg:w-3/6 w-full">
                    ...
                    <input
                      ...
                      required
                      id="username"
                      className="border border-gray-300 pl-3 py-3 shadow-sm rounded text-sm focus:outline-none bg-transparent dark:border-gray-700 dark:hover:border-indigo-600 focus:border-indigo-700 text-gray-800 dark:text-gray-100"
                      placeholder="@example"
                    />
                  </div>
                  <div className="mt-8 flex flex-col xl:w-4/5 lg:w-w-4/5 w-full">
                    ...
                    <textarea
                      ...
                      name="about"
                      required
                      className="border border-gray-300 pl-3 py-2 shadow-sm rounded text-sm focus:outline-none focus:border-indigo-700 bg-transparent dark:border-gray-700 dark:hover:border-indigo-600 dark:text-gray-100 resize-none"
              ...
              <div className="w-full py-4 sm:px-8 px-5 bg-gray-100 dark:bg-gray-700 flex justify-end">
                <button className="btn text-sm focus:outline-none text-gray-600 dark:text-gray-400 border border-gray-300 py-2 px-6 mr-4 rounded hover:bg-gray-200 transition duration-150 ease-in-out">
                  Back
                </button>
                <button
