      ...
      <div className="flex items-center justify-center py-8 bg-gray-300 px-4">
        <div className="bg-white rounded-lg xl:w-10/12 md:w-11/12 w-full px-5 py-10 sm:py-10 sm:px-10">
          <div className="bg-gray-50 rounded py-6 xl:px-24 px-4 flex items-center justify-center">
            <div className="grid sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-7 items-center">
              ...
              <div className="flex items-center sm:mt-0 mt-4">
                ...
                <p className="text-base leading-4 ml-6 md:ml-3 lg:ml-6 text-indigo-700">
                  Meal
                </p>
              </div>
          ...
          <div>
            <h1
              role="heading"
              className="text-2xl font-semibold leading-6 mt-8 text-gray-900"
            >
              Meal Preferences
            </h1>
          ...
          <div className="w-full md:flex items-center justify-between mt-7">
            <div className="md:w-3/5 w-full">
              <label
                className="text-base font-semibold leading-4 text-center text-gray-600"
                id="breakfast"
              >
                Breakfast
              </label>
              <div className="border rounded border-gray-300 w-full mt-4 relative">
                <select
                  ...
                  className="w-full p-6 foucs:outline-none appearance-none"
                  aria-labelledby="breakfast"
                >
                  <option className="text-base leading-none text-center text-gray-900 capitalize truncate">
          ...
          <div className="flex items-center justify-between space-x-2 flex-row mt-12">
            <button className="text-base font-medium leading-4 border rounded border-gray-300 text-center text-gray-500 hover:bg-gray-100 focus:ring-2 focus:ring-offset-2 focus:ring-gray-700 focus:outline-none py-3.5 px-10 w-2/3 sm:w-auto">
              Back
            </button>
            <button className="text-base font-medium leading-4 py-3.5 px-6 bg-indigo-700 rounded  text-center text-white hover:bg-indigo-600 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:outline-none w-2/3 sm:w-auto">
              Continue
            </button>
          </div>
        </div>
