      ...
      <div className="md:flex justify-between w-full ">
        ...
        <div className="h-full relative">
          <div className="2xl:pl-20 pl-8 pt-8 lg:flex hidden items-center border-gray-200 border-b">
            ...
            <div className="flex items-center 2xl:ml-24 ml-16">
              <p className="text-base font-bold border-b-2 pb-7 border-indigo-700 cursor-pointer mr-10 leading-4 text-indigo-700">
                01.About you
              </p>
              <p className="text-base font-medium border-b-2 pb-7 border-transparent hover:border-indigo-700 cursor-pointer mr-10 leading-4 text-gray-800">
                02.Position
              </p>
              <p className="text-base font-medium border-b-2 pb-7 border-transparent hover:border-indigo-700 cursor-pointer mr-10 leading-4 text-gray-800">
                03.Work
              ...
              <p className="text-base font-medium border-b-2 pb-7 border-transparent hover:border-indigo-700 cursor-pointer leading-4 text-gray-800">
                05.Essay
              </p>
            </div>
          </div>
          <div className="2xl:p-20 p-8">
            <p className="md:w-96 md:text-3xl text-xl md:text-left text-center font-semibold leading-10 text-gray-800">
            ...
            <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6 items-center md:justify-start w-full justify-center">
              <div className="flex flex-col items-center bg-white shadow rounded-lg py-10 px-14 relative">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                  role="img"
                  aria-label="Graduate Cap Logo"
                >
                  <path
                    d="M77 31.5L42 17.5L7 31.5L42 45.5L77 31.5ZM77 31.5V52.5"
                    stroke="#4338CA"
                    strokeWidth="5.25"
                    strokeLinecap="round"
                  ...
                  />
                  <path
                    d="M21 37.1V56C21 58.7848 23.2125 61.4555 27.1508 63.4246C31.089 65.3938 36.4305 66.5 42 66.5C47.5695 66.5 52.911 65.3938 56.8492 63.4246C60.7875 61.4555 63 58.7848 63 56V37.1"
                    stroke="#4338CA"
                    strokeWidth="5.25"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                ...
                <p className="text-xl font-medium leading-5 mt-10 text-gray-800 text-center">
                  Teacher
                </p>
              ...
              <div className="flex flex-col items-center bg-white hover:shadow cursor-pointer py-10 px-14 md:mt-0 mt-4">
                ...
                >
                  <path
                    d="M10.5 66.5C15.2886 63.7353 20.7206 62.2798 26.25 62.2798C31.7794 62.2798 37.2114 63.7353 42 66.5C46.7886 63.7353 52.2206 62.2798 57.75 62.2798C63.2794 62.2798 68.7114 63.7353 73.5 66.5"
                    stroke="#4B5563"
                    strokeWidth="5.25"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M10.5 21C15.2886 18.2353 20.7206 16.7798 26.25 16.7798C31.7794 16.7798 37.2114 18.2353 42 21C46.7886 18.2353 52.2206 16.7798 57.75 16.7798C63.2794 16.7798 68.7114 18.2353 73.5 21"
                    stroke="#4B5563"
                    strokeWidth="5.25"
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <div className="flex flex-col items-center bg-white hover:shadow cursor-pointer py-10 px-14 xl:mt-0">
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  aria-label="speaker logo"
                  role="img"
                >
                  <path
                    d="M63 28C65.7848 28 68.4555 29.1062 70.4246 31.0754C72.3938 33.0445 73.5 35.7152 73.5 38.5C73.5 41.2848 72.3938 43.9555 70.4246 45.9246C68.4555 47.8938 65.7848 49 63 49"
                    stroke="#4B5563"
                    strokeWidth="5.25"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M35 28V66.5C35 67.4283 34.6313 68.3185 33.9749 68.9749C33.3185 69.6313 32.4283 70 31.5 70H28C27.0717 70 26.1815 69.6313 25.5251 68.9749C24.8687 68.3185 24.5 67.4283 24.5 66.5V49"
                    stroke="#4B5563"
                    strokeWidth="5.25"
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <div className="flex flex-col items-center bg-white hover:shadow cursor-pointer py-10 px-14 2xl:mt-0 ">
                ...
                >
                  <path
                    d="M42 52.5C53.598 52.5 63 43.098 63 31.5C63 19.902 53.598 10.5 42 10.5C30.402 10.5 21 19.902 21 31.5C21 43.098 30.402 52.5 42 52.5Z"
                    stroke="#4B5563"
                    strokeWidth="5.25"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M42.0068 52.5117L53.9068 73.1231L59.5001 61.8109L72.0934 62.6231L60.1934 42.0117"
                    stroke="#4B5563"
                    strokeWidth="5.25"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M23.8066 42.0117L11.9066 62.6231L24.4999 61.8109L30.0932 73.1231L41.9932 52.5117"
                    stroke="#4B5563"
                    strokeWidth="5.25"
                    strokeLinecap="round"
                    strokeLinejoin="round"
            ...
            <div className="md:flex hidden items-center w-full justify-between md:mt-10 xl:mt-44">
              <button className="flex items-center p-3.5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-700 hover:text-gray-700 text-gray-800">
                ...
                <span className="text-base font-medium leading-4 ml-3 text-center">
                  Back
                </span>
              </button>
              <button className="flex items-center bg-indigo-700 rounded p-3.5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 hover:bg-indigo-600">
                <span className="text-base font-medium leading-4 pr-7 text-center text-white">
                  Conitnue
                </span>
                <svg
                  width={24}
        ...
        <div className="bg-white md:w-72 h-full relative flex flex-col  items-center justify-center w-full md:px-3 md:pt-0 pt-4 md:pb-24 pb-4 md:pt-40 lg:pt-0">
          <div className="flex flex-col items-center md:mt-72 xl:mt-64 mt-12 justify-center">
            <div className="mt- relative w-44 h-44 z-10 flex items-center h-full justify-center">
              ...
              <div className="absolute flex flex-col items-center z-0 justify-center">
                ...
                <p className="text-base leading-4 pt-2 text-center text-gray-900">
                  Completed
                </p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between md:mt-80 xl:mt-56 mt-12  px-8 w-full">
            <p className="text-base font-medium leading-4 text-center text-gray-800">
              Step
            </p>
            <p className="text-base font-medium leading-4 text-center text-gray-800">
              2/5
