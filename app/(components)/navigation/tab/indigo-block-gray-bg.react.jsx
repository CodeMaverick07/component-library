        ...
        <div className="xl:w-full xl:mx-0 rounded bg-gray-200 h-12 shadow">
          <ul className="flex items-center h-full">
            <li
              ...
              className={
                activeStatus == 1
                  ? "text-sm text-white flex items-center h-full px-5 bg-indigo-700 py-4 rounded-md mr-10 font-normal"
                  : "text-sm text-gray-600 h-full flex items-center pt-5 pb-5 mr-10 font-normal hover:text-gray-700 cursor-pointer"
              }
            >
