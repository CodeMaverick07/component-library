...
const Index = () => {
  ...
  return (
    <div>
      <div className="sm:hidden w-11/12 mx-auto relative rounded">
      ...
      <div className="justify-between flex-wrap hidden sm:block shadow rounded">
        <div className="xl:w-full xl:mx-0 pl-5 pr-5 bg-gray-200 h-12">
          <ul className="flex items-center bg-gray-200 h-full">
            <li
              onClick={() => setActiveStatus(1)}
              className={
                activeStatus == 1
                  ? "text-sm text-gray-800 py-2 bg-white px-5 rounded-md mr-10 font-normal"
                  : "text-sm text-gray-600 pt-2 pb-2 mr-10 font-normal hover:text-gray-800 cursor-pointer"
              }
            >
