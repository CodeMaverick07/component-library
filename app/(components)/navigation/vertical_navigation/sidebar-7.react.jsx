  ...
  return (
    <div>
      <div className="bg-gray-50 xl:hidden flex justify-between w-full p-6 items-center">
        <button className="text-gray-800 hover:text-black focus:outline-none focus:text-black flex justify-between  items-center space-x-3">
          <svg
            width={34}
            height={34}
            viewBox="0 0 34 34"
      ...
      <div
        ...
        } bg-gray-50 pb-48 transform  xl:translate-x-0 ease-in-out transition duration-500 flex justify-start items-start w-full sm:w-64  flex-col h-full`}
      >
        ...
        <div className="xl:mt-6 flex flex-col justify-start items-center  px-4 w-full space-y-3 pb-5 ">
          ...
          <button className="focus:outline-none flex jusitfy-start hover:text-indigo-700 focus:bg-indigo-50 focus:text-indigo-700 hover:bg-indigo-50 text-gray-600 rounded py-3 pl-4 items-center space-x-6 w-full ">
            ...
            >
              <path
                d="M19.0001 5H5.00006C3.89549 5 3.00006 5.89543 3.00006 7V17C3.00006 18.1046 3.89549 19 5.00006 19H19.0001C20.1046 19 21.0001 18.1046 21.0001 17V7C21.0001 5.89543 20.1046 5 19.0001 5Z"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              <path
                d="M3.00006 7L12.0001 13L21.0001 7"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          <button className="focus:outline-none flex justify-start items-center space-x-6 hover:text-indigo-700 focus:bg-indigo-50 focus:text-indigo-700 hover:bg-indigo-50 text-gray-600 rounded py-3 pl-4   w-full ">
            ...
            >
              <path
                d="M18.0002 5H6.00018C4.89561 5 4.00018 5.89543 4.00018 7V19C4.00018 20.1046 4.89561 21 6.00018 21H18.0002C19.1048 21 20.0002 20.1046 20.0002 19V7C20.0002 5.89543 19.1048 5 18.0002 5Z"
                stroke="#4B5563"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          <button className="focus:outline-none flex justify-start items-center space-x-6 hover:text-indigo-700 focus:bg-indigo-50 focus:text-indigo-700 hover:bg-indigo-50 text-gray-600 rounded  py-3 pl-4   w-full ">
            ...
            >
              ...
              />
              <path
                d="M10.0001 4L19.0001 8L10.0001 12"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          <button className="focus:outline-none flex justify-start items-center space-x-6 hover:text-indigo-700 focus:bg-indigo-50 focus:text-indigo-700 hover:bg-indigo-50 text-gray-600 rounded  py-3 pl-4   w-full ">
            ...
            >
              <path
                d="M14.0001 8C15.1047 8 16.0001 7.10457 16.0001 6C16.0001 4.89543 15.1047 4 14.0001 4C12.8956 4 12.0001 4.89543 12.0001 6C12.0001 7.10457 12.8956 8 14.0001 8Z"
                stroke="#4B5563"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
              ...
              />
              <path
                d="M8.00012 14C9.10469 14 10.0001 13.1046 10.0001 12C10.0001 10.8954 9.10469 10 8.00012 10C6.89555 10 6.00012 10.8954 6.00012 12C6.00012 13.1046 6.89555 14 8.00012 14Z"
                stroke="#4B5563"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
              ...
              />
              <path
                d="M17.0001 20C18.1047 20 19.0001 19.1046 19.0001 18C19.0001 16.8954 18.1047 16 17.0001 16C15.8956 16 15.0001 16.8954 15.0001 18C15.0001 19.1046 15.8956 20 17.0001 20Z"
                stroke="#4B5563"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
