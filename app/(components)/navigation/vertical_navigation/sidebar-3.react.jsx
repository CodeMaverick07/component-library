  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        } rounded transform  xl:translate-x-0 ease-in-out transition duration-500 flex justify-start items-start w-full sm:w-64 border-r border-b border-gray-200  flex-col h-full`}
      >
