  ...
  return (
    <div className="relative h-screen">
      ...
      <div
        ...
        } sm:absolute top-0 sm:z-20 bg-gray-50  ease-in-out transition transform  xl:translate-x-0 duration-500 flex justify-start items-start w-full sm:w-64    flex-col h-full`}
      >
        ...
        <div className="p-8  flex jusitf-start items-start flex-col space-y-2">
          <div>
            <img src="https://i.ibb.co/n83NqpH/Ellipse-2-1.png" alt="avatar" />
          </div>
          <div className="flex justify-start items-start flex-col space-y-1">
            <p className="cursor-pointer text-lg font-semibold leading-4  text-gray-800">
              Alexis Enache
            </p>
            <p className="cursor-pointer text-xs leading-3 text-gray-600">
              Alpha Squad
            </p>
          </div>
        </div>
        ...
        <div className="mt-6 flex flex-col justify-start items-start  px-4 w-full space-y-3 pb-5 ">
          <button className="focus:outline-none flex jusitfy-start hover:border-indigo-700 border border-transparent focus:border-indigo-700 focus:text-indigo-700 hover:text-indigo-700 text-gray-800 rounded py-3 pl-4 items-center space-x-6 w-full ">
            <svg
          ...
          <button className="focus:outline-none space-x-10 flex jusitfy-start hover:border-indigo-700 border border-transparent focus:orderg-indigo-700 focus:text-indigo-700 hover:text-indigo-700 text-gray-800 rounded py-3 px-4 items-center  w-full ">
            ...
            <div className="py-1.5 px-2 bg-indigo-700 text-xs leading-3 text-gray-50 rounded-full">
              8
            </div>
          </button>
          <button className="focus:outline-none flex jusitfy-start hover:border-indigo-700 border border-transparent focus:border-indigo-700 focus:text-indigo-700 hover:text-indigo-700 text-gray-800 rounded py-3 pl-4 items-center space-x-6 w-full">
        ...
        <div className="pb-48 flex flex-col justify-start items-start h-full     w-full  ">
          <div className="flex pt-5  justify-start pb-6 px-4   pl-4 flex-col items-start w-full">
            <button className="focus:outline-none flex jusitfy-start hover:border-indigo-700 border border-transparent focus:border-indigo-700 focus:text-indigo-700 hover:text-indigo-700 text-gray-800 rounded py-3 pl-4 items-center space-x-6 w-full">
              <svg
                width={24}
                height={24}
