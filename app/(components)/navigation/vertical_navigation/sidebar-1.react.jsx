      ...
      >
        <div>
          <div className="flex items-center justify-between">
            <p className="text-sm xl:text-lg font-bold leading-tight tracking-tight text-gray-600 dark:text-gray-400 capitalize">
              Web application UI
            </p>
            <div
          ...
          <div>
            <div className={"pt-8"}>
              <div
                onClick={() => (list === 0 ? setList(null) : setList(0))}
                className="cursor-pointer flex w-full justify-between pb-3 border-b-2 border-gray-200 dark:border-gray-800"
              >
                <p className="select-none text-sm xl:text-lg leading-tight tracking-tight text-gray-800 dark:text-gray-400 capitalize">
                  Master layouts
                </p>
                <button className="focus:outline-none">
                  ...
                  <svg
                    className={
                      list === 0 ? "text-gray-800 dark:text-gray-400" : "hidden"
                    }
                    xmlns="http://www.w3.org/2000/svg"
                    width={20}
                    height={20}
              ...
              <div className={list === 0 ? "pl-2 block" : "hidden"}>
                <div className="flex flex-col">
                  ...
                  <div className="flex items-stretch justify-between">
                    ...
                    <p className="text-lg leading-tight tracking-tight text-gray-900 dark:text-gray-400">
                      13
                    </p>
                  </div>
            ...
            <div className={"pt-8"}>
              <div
                onClick={() => (list === 3 ? setList(null) : setList(3))}
                className="cursor-pointer flex w-full justify-between pb-3 border-b-2 border-gray-200 dark:border-gray-800"
              >
                <p className="select-none text-sm xl:text-lg leading-tight tracking-tight text-gray-800 dark:text-gray-400 capitalize">
                  Layout
                ...
                <button className="focus:outline-none">
                  ...
                  <svg
                    className={
                      list === 3 ? "text-gray-800 dark:text-gray-400" : "hidden"
                    }
                    xmlns="http://www.w3.org/2000/svg"
                    width={20}
                    height={20}
            ...
            <div className={"pt-8"}>
              <div
                onClick={() => (list === 1 ? setList(null) : setList(1))}
                className="cursor-pointer flex w-full justify-between pb-3 border-b-2 border-gray-200 dark:border-gray-800"
              >
                <p className="select-none text-sm xl:text-lg leading-tight tracking-tight text-gray-800 dark:text-gray-400 capitalize">
                  Navigation
                ...
                <button className="focus:outline-none">
                  ...
                  <svg
                    className={
                      list === 1 ? "text-gray-800 dark:text-gray-400" : "hidden"
                    }
                    xmlns="http://www.w3.org/2000/svg"
                    width={20}
                    height={20}
            ...
            <div className={"pt-8"}>
              <div
                onClick={() => (list === 2 ? setList(null) : setList(2))}
                className="cursor-pointer flex w-full justify-between pb-3 border-b-2 border-gray-200 dark:border-gray-800"
              >
                <p className="select-none text-sm xl:text-lg leading-tight tracking-tight text-gray-800 dark:text-gray-400 capitalize">
                  Heading
                ...
                <button className="focus:outline-none">
                  ...
                  <svg
                    className={
                      list === 2 ? "text-gray-800 dark:text-gray-400" : "hidden"
                    }
                    xmlns="http://www.w3.org/2000/svg"
                    width={20}
                    height={20}
