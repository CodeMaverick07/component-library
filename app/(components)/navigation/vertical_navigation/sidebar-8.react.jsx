  ...
  return (
    <div className="relative h-[130vh]">
      ...
      <div
        ...
        } sm:absolute transform  xl:translate-x-0 sm:top-0 sm:z-20 bg-white  sm:shadow  ease-in-out transition duration-500 flex justify-start items-start w-full sm:w-64  flex-col `}
      >
        ...
        <div className="mt-8 pl-4 pb-8 lex flex-col justify-start items-center      w-full  ">
          <div className="pl-4  flex  justify-start    items-center w-full space-x-2">
            <div>
              <img
                className
                src="https://i.ibb.co/cxTKKVf/Ellipse-2-3.png"
                alt="avatar"
              />
            </div>
        ...
        <div className="flex pl-8 justify-start items-center space-x-6">
          <div className="cursor-pointer my-5 rounded-full relative shadow-sm ">
            <input
              ...
              name="toggle"
              id="toggle1"
              className="bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-offset-2  checkbox w-4 h-4 rounded-full bg-white absolute  shadow-sm appearance-none cursor-pointer"
            />
            <label
              htmlFor="toggle1"
              className="toggle-label dark:bg-gray-700 block w-8 h-4 overflow-hidden rounded-full bg-gray-300 cursor-pointer"
            />
          </div>
