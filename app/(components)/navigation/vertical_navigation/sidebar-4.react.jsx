  ...
  return (
    <div className="relative h-[130vh]">
      ...
      <div
        ...
        } sm:absolute transform  xl:translate-x-0 top-0 sm:z-20 bg-white  ease-in-out transition duration-500 flex justify-start items-start w-full  sm:w-72 border-r border-b border-gray-200  flex-col `}
      >
        ...
        <div className="flex justify-start w-80 sm:w-auto items-start mx-6 border-gray-300 rounded-md border">
          <button
            ...
            className={`${
              color ? "bg-indigo-700 text-white" : "bg-white text-gray-800"
            } w-full sm:w-auto py-4 px-7 text-base leading-none rounded-md`}
          >
            Personal
          </button>
          <button
            ...
            className={` ${
              color ? "bg-white text-gray-800" : "bg-indigo-700 text-white"
            }  w-full sm:w-auto py-4 px-7 text-base leading-none  rounded-md  `}
          >
            Business
          </button>
        ...
        <div className="   mt-6 flex flex-col px-6 justify-start items-center  px-4 w-full   ">
          <button className="focus:outline-none flex jusitfy-start   focus:text-gray-800  text-gray-600 hover:text-gray-800 rounded py-3  items-center space-x-6 w-full ">
            ...
            <p className="text-base leading-4 border-b border-transparent  hover:border-gray-800 focus:border-gray-800  ">
              Dashboard
            </p>
          </button>
        ...
        <div className="  mt-6 flex flex-col px-6 justify-start items-center  px-4 w-full  ">
          ...
          <button className="focus:outline-none flex justify-start items-center space-x-6  focus:text-gray-800   text-gray-600 hover:text-gray-800 rounded  py-3    w-full ">
            ...
            >
              <path
                d="M14.0001 8C15.1046 8 16.0001 7.10457 16.0001 6C16.0001 4.89543 15.1046 4 14.0001 4C12.8955 4 12.0001 4.89543 12.0001 6C12.0001 7.10457 12.8955 8 14.0001 8Z"
                stroke="#4B5563"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
              ...
              />
              <path
                d="M8.00006 14C9.10463 14 10.0001 13.1046 10.0001 12C10.0001 10.8954 9.10463 10 8.00006 10C6.89549 10 6.00006 10.8954 6.00006 12C6.00006 13.1046 6.89549 14 8.00006 14Z"
                stroke="#4B5563"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
              ...
              />
              <path
                d="M17.0001 20C18.1046 20 19.0001 19.1046 19.0001 18C19.0001 16.8954 18.1046 16 17.0001 16C15.8955 16 15.0001 16.8954 15.0001 18C15.0001 19.1046 15.8955 20 17.0001 20Z"
                stroke="#4B5563"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
        ...
        <div className="px-6 pb-8 lex flex-col justify-between items-center h-full space-y-36    w-full mt-36 ">
          <div className=" border rounded-md border-gray-300 flex  justify-start p-2    items-center w-full space-x-4">
            ...
            <div className="flex flex-col  justify-start items-start space-y-2">
              <p className="cursor-pointer text-base leading-4 text-gray-800">
                Alexis Enache
              </p>
              <p className="cursor-pointer text-xs leading-3 text-gray-500">
