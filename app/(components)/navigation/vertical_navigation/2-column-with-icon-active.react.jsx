  ...
  return (
    <div>
      ...
      <div className="flex flex-no-wrap">
        <div className="absolute border-r border-gray-100 sm:relative h-full bg-gray-100 z-20 p-4">
          <div className="flex w-full">
            <div className="w-1/4 flex justify-center flex-col ">
              <div className="cursor-pointer" onClick={() => setShow(!show)}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="icon icon-tabler icon-tabler-menu-2 cursor-pointer mt-1"
                  width={20}
                  height={20}
                  viewBox="0 0 24 24"
                  strokeWidth="1.5"
              ...
              <ul aria-orientation="vertical" className="rounded py-8">
                <li className="cursor-pointer text-indigo-700 text-sm leading-3 tracking-normal pt-4 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                  <div className="">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-6 pt-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex items-center">
                ...
                <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-6 pt-2 hover:text-indigo-700 flex items-center focus:text-indigo-700 focus:outline-none">
                  <span className="text-gray-800">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
            ...
            <div
              className={
                show
                  ? "w-3/4 flex justify-start flex-col pr-12 transition duration-150 ease-in-out hidden"
                  : "w-3/4 flex justify-start flex-col pr-12 transition duration-150 ease-in-out"
              }
            >
              <div className="mt-2">
                <svg
              ...
              <ul aria-orientation="vertical" className="rounded py-8">
                <li className="cursor-pointer text-indigo-700 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                  <span className="ml-2">Dashboard</span>
                </li>
                <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-6 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex items-center">
                  <span className="ml-2">Products</span>
                </li>
                <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-6 py-2 hover:text-indigo-700 flex items-center focus:text-indigo-700 focus:outline-none">
