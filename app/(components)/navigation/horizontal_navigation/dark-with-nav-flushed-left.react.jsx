  ...
  return (
    <>
      <div classname="bg-gray-200 h-full w-full">
        <nav className="w-full mx-auto bg-gray-800 shadow xl:block hidden">
          <div className="justify-between container px-6 h-16 flex items-center lg:items-stretch mx-auto">
            <div className="flex items-center">
              ...
              <ul className="pr-32 xl:flex hidden items-center h-full">
                ...
                <li
                  className="cursor-pointer hover:text-indigo-700 transition duration-150 ease-in-out h-full flex items-center text-sm text-white mx-10 tracking-normal relative text-white hover:text-indigo-700"
                ...
                <li className="cursor-pointer hover:text-indigo-700 transition duration-150 ease-in-out h-full flex items-center text-sm text-white mr-10 tracking-normal text-white hover:text-indigo-700">
                  Performance
                </li>
                <li
                  className="cursor-pointer hover:text-indigo-700 transition duration-150 ease-in-out h-full flex items-center text-sm text-white tracking-normal relative"
            ...
            <div className="h-full xl:flex hidden items-center justify-end">
              <div className="h-full flex items-center">
                <div className="w-32 pr-16 h-full flex items-center justify-end border-gray-700 border-r" />
        ...
        {/* Navbar */}
        <nav>
          <div className="py-4 px-6 w-full flex xl:hidden justify-between items-center bg-gray-800 fixed top-0 z-0">
            <div className="w-24">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width={43}
                          ...
                          {product && (
                            <div>
                              <ul className="my-3">
                                ...
                                <li className="text-white xl:text-base md:text-2xl text-base hover:text-indigo-500 py-2 px-6">
                                  Out of Stock
                                </li>
                                <li className="text-white xl:text-base md:text-2xl text-base hover:text-indigo-500 py-2 px-6">
                                  New Products
