        ...
        <>
            <div className="bg-gray-200 h-full w-full">
                ...
                <nav className="w-full mx-auto bg-white shadow xl:block hidden">
                    <div className="container px-6 h-16 flex items-center lg:items-stretch justify-between mx-auto">
                        ...
                        <ul className="flex items-center justify-center h-full">
                            <li className="cursor-pointer h-full xl:flex items-center text-sm text-indigo-700 tracking-normal hidden">Dashboard</li>
                            <li className="cursor-pointer h-full xl:flex items-center text-sm text-gray-800 ml-10 tracking-normal hidden hover:text-indigo-700 transition duration-150 ease-in-out">Products</li>
                            ...
                            <li className="cursor-pointer h-full xl:flex items-center text-sm text-gray-800 mr-10 tracking-normal hidden hover:text-indigo-700 transition duration-150 ease-in-out">Performance</li>
                            <li className="cursor-pointer h-full xl:flex items-center text-sm text-gray-800 tracking-normal hidden hover:text-indigo-700 transition duration-150 ease-in-out">Deliverables</li>
                        </ul>
                ...
                <nav>
                    ...
                    <div className={show ? "absolute w-full h-full transform -translate-x-0 z-40 xl:hidden" : "absolute w-full h-full transform -translate-x-full z-40 xl:hidden"} id="mobile-nav">
