        ...
        <nav className="w-full mx-auto bg-gray-800 shadow xl:block hidden">
          <div className="container px-6 h-16 flex items-center lg:items-stretch justify-between mx-auto">
            ...
            <ul className="flex items-center justify-center h-full">
              <li className="cursor-pointer h-full xl:flex items-center text-sm text-indigo-700 tracking-normal hidden">
                Dashboard
              </li>
              <li className="cursor-pointer h-full xl:flex items-center text-sm text-white ml-10 tracking-normal hidden hover:text-indigo-700 transition duration-150 ease-in-out">
                Products
              </li>
              ...
              <li className="cursor-pointer h-full xl:flex items-center text-sm text-white mr-10 tracking-normal hidden hover:text-indigo-700 transition duration-150 ease-in-out">
                Performance
              </li>
              <li className="cursor-pointer h-full xl:flex items-center text-sm text-white tracking-normal hidden hover:text-indigo-700 transition duration-150 ease-in-out">
                Deliverables
              </li>
            </ul>
            <div
