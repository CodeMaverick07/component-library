          ...
          <div className=" flex flex-row justify-between">
            ...
            <div className="lg:flex hidden flex-auto justify-between flex-row">
              <div className=" xl:pl-16 lg:pl-4">
                <div className=" flex space-x-1 items-center">
                  <div className=" focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 cursor-pointer w-3 h-3 rounded-full bg-white flex justify-center items-center">
                    ...
                    >
                      <path
                        d="M2.8999 1.20001L1.0999 3.00001L2.8999 4.80001"
                        stroke="#1F2937"
                        strokeWidth="0.5"
                        strokeLinecap="round"
                  ...
                  <a
                    className="focus:text-gray-700 hover:text-gray-700 duration-100 border-b border-gray-600 font-normal text-xs leading-3 text-gray-600 pb-1"
              ...
              <div className="flex flex-row lg:space-x-3 xl:space-x-4">
                <div className=" focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800  flex -space-x-3 flex-row">
                  <img
                    className="z-50"
                    src="https://i.ibb.co/6JM49zg/Ellipse-16.png"
                    alt="individual person image-1"
                  />
                  <img
                    className="z-40"
                    src="https://i.ibb.co/GJQPgHw/Ellipse-15.png"
                    alt="individual person image-2"
                  />
                  <img
                    className="z-30"
                  ...
                  <img
                    className="z-20"
                    src="https://i.ibb.co/60dJ3WT/Ellipse-13.png"
                    alt="individual person image-4"
                  />
                  <img
                    className="z-10"
                    src="https://i.ibb.co/ry4hYQs/Ellipse-10.png"
                    alt="individual person image-5"
                  />
                </div>
                <button className="rounded-md flex space-x-2 w-24 h-10 font-normal text-sm leading-3 text-gray-800 bg-white focus:outline-none focus:bg-gray-200 hover:bg-gray-200 duration-150 justify-center items-center">
                  ...
                  >
                    <path
                      d="M10.5 4.66669C11.4665 4.66669 12.25 3.88319 12.25 2.91669C12.25 1.95019 11.4665 1.16669 10.5 1.16669C9.5335 1.16669 8.75 1.95019 8.75 2.91669C8.75 3.88319 9.5335 4.66669 10.5 4.66669Z"
                      stroke="#1F2937"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    ...
                    />
                    <path
                      d="M10.5 12.8333C11.4665 12.8333 12.25 12.0498 12.25 11.0833C12.25 10.1168 11.4665 9.33331 10.5 9.33331C9.5335 9.33331 8.75 10.1168 8.75 11.0833C8.75 12.0498 9.5335 12.8333 10.5 12.8333Z"
                      stroke="#1F2937"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M5.01074 7.88086L8.99491 10.2025"
                      stroke="#1F2937"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M8.98908 3.79749L5.01074 6.11915"
                      stroke="#1F2937"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
            ...
            <div className=" hidden sm:flex xl:pl-4 lg:pl-3 justify-end flex-row sm:space-x-4 md:space-x-6 lg:space-x-3 xl:space-x-4">
              ...
              <button className="rounded-md flex space-x-2 w-24 h-10 font-normal text-sm leading-3 text-white bg-indigo-700 focus:outline-none focus:bg-indigo-600 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 hover:bg-indigo-600 duration-150 justify-center items-center">
                ...
                >
                  <path
                    d="M11.0833 12.25H2.91667C2.60725 12.25 2.3105 12.1271 2.09171 11.9083C1.87292 11.6895 1.75 11.3928 1.75 11.0833V2.91667C1.75 2.60725 1.87292 2.3105 2.09171 2.09171C2.3105 1.87292 2.60725 1.75 2.91667 1.75H9.33333L12.25 4.66667V11.0833C12.25 11.3928 12.1271 11.6895 11.9083 11.9083C11.6895 12.1271 11.3928 12.25 11.0833 12.25Z"
                    stroke="white"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M9.91683 12.25V7.58331H4.0835V12.25"
                    stroke="white"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M4.0835 1.75V4.66667H8.75016"
                    stroke="white"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
          ...
          <div className="lg:hidden flex flex-auto justify-between flex-row mt-4">
            ...
            >
              <div className=" flex space-x-1 items-center">
                ...
                <a
                  className="focus:outline-none focus:text-gray-700 hover:text-gray-700 duration-100 border-b border-gray-600 font-normal text-xs leading-3 text-gray-600 pb-1"
                  href="javascript:void(0)"
                >
                  Back to Dashboard
                </a>
