      ...
      <div className="flex-col md:flex-row flex items-center md:justify-center">
        ...
        >
          {tooltipStatus == 1 && (
            <div
              role="tooltip"
              className="z-20 transition duration-150 ease-in-out bottom-0 mb-8 absolute shadow-lg pt-4 pr-2 pl-3 pb-5 bg-white text-gray-600 rounded w-40"
            >
              <svg
        ...
        >
          {tooltipStatus == 2 && (
            <div
              role="tooltip"
              className="z-20 transition duration-150 ease-in-out bottom-0 mb-8 shadow-lg pt-4 pr-2 pl-3 pb-5 bg-indigo-700 text-gray-600 rounded w-40 absolute"
            >
              <svg
                className="absolute bottom-0 -mb-2"
                width="16px"
        ...
        >
          {tooltipStatus == 3 && (
            <div
              role="tooltip"
              className="z-20 transition duration-150 ease-in-out bottom-0 mb-8 absolute shadow-lg pt-4 pr-2 pl-3 pb-5 bg-gray-800 text-gray-600 rounded w-40"
            >
              <svg
                className="absolute bottom-0 -mb-2"
                width="16px"
