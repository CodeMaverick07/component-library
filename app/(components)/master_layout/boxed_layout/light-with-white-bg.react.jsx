  ...
  return (
    <>
      <div>
        ...
        {/* Navigation ends */}
        {/* Page title starts */}
        <div className="my-6 lg:my-12 container px-6 mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between border-b border-gray-300 pb-4">
          <div>
          ...
          <div className="mt-6 lg:mt-0">
            <button className="mr-3 bg-gray-200 hover:bg-gray-300 transition duration-150 ease-in-out focus:outline-none rounded text-indigo-700 px-5 py-2 text-sm">
              Back
            </button>
