...
function Index() {
    ...
    return (
        <div>
            ...
            {/* Mobile */}
            {/* Navigation starts */}
            <nav className="w-full mx-auto bg-gray-800 shadow">
                <div className="justify-between container px-6 h-16 flex items-center lg:items-stretch mx-auto">
                    <div className="flex items-center">
                        ...
                        <ul className="pr-32 xl:flex hidden items-center h-full">
                            <li className="cursor-pointer h-full flex items-center text-sm text-indigo-500 tracking-normal">Dashboard</li>
                            <li className="cursor-pointer h-full flex items-center text-sm text-white mx-10 tracking-normal relative" onClick={() => setProduct(!product)}>
                                {product ? (
                            ...
                            <li className="cursor-pointer h-full flex items-center text-sm text-white mr-10 tracking-normal ">Performance</li>
                            <li className="cursor-pointer h-full flex items-center text-sm text-white tracking-normal relative" onClick={() => setDeliverables(!deliverables)}>
                                {deliverables ? (
                                    <ul className="bg-white shadow rounded py-1 w-32 left-0 mt-16 -ml-4 absolute  top-0">
                                        <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">Landing Pages</li>
                                        <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">Templates</li>
                    ...
                    <div className="h-full xl:flex hidden items-center justify-end">
                        <div className="h-full flex items-center">
                            <div className="w-32 pr-16 h-full flex items-center justify-end border-gray-700 border-r"></div>
                            <div className="w-full h-full flex">
                                <div className="w-16 xl:w-32 h-full flex items-center justify-center xl:border-r border-gray-700">
                                    <div className="relative">
                                        <div className="w-6 h-6 xl:w-auto xl:h-auto text-gray-400">
                                ...
                                <div aria-haspopup="true" onClick={() => setProfile(!profile)} className="cursor-pointer w-full flex items-center justify-end relative">
                    ...
                    <div className="xl:hidden" onClick={() => setShow(!show)}>
                        <svg aria-label="Main Menu" aria-haspopup="true" xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-menu" width={32} height={32} viewBox="0 0 24 24" strokeWidth="1.5" stroke="#ffffff" fill="none" strokeLinecap="round" strokeLinejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" />
            ...
            <div className="bg-gray-200 w-full">
                <div className="container px-6 py-6 sm:py-0 mx-auto">
                    ...
                    <ul className="hidden sm:flex flex-col sm:flex-row items-start sm:items-center h-full py-5">
                        <li className="px-6 py-2 flex items-center justify-center bg-white shadow text-sm text-gray-800 rounded">Active</li>
                        <li className="px-6 flex items-center justify-center my-5 sm:my-0 text-sm text-gray-600">Earnings</li>
                        <li className="px-6 flex items-center justify-center mb-5 sm:mb-0 text-sm text-gray-600">Forecasting</li>
                        <li className="px-6 flex items-center justify-center text-sm text-gray-600">Reports</li>
                    </ul>
                </div>
            </div>
            {/* Page title ends */}
