    ...
    return (
        <div>
            ...
            <div className="bg-gray-200 ">
                <nav className="w-full mx-auto bg-gray-800 shadow z-20 relative">
                    <div className="container px-6 h-16 flex items-center justify-between mx-auto">
                        <div className="w-auto flex items-center">
                            <div className="rounded-full relative p-3 flex justify-end text-gray-500">
                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-search" width={20} height={20} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" />
                                    <circle cx={10} cy={10} r={7} />
                                    <line x1={21} y1={21} x2={15} y2={15} />
                                </svg>
                        ...
                        <div aria-haspopup="true" className="cursor-pointer h-full xl:flex items-center justify-end hidden relative" onclick="dropdownHandler(this)">
                            <ul className="p-2 w-40 border-r bg-white absolute rounded z-40  shadow mt-64 hidden">
                ...
                <div>
                    {/* Page title starts */}
                    <div className="bg-gray-800 pt-8 pb-20">
                        <div className="container px-6 mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between">
                            <div>
                                <p className="flex items-center text-gray-300 text-xs">
                                    ...
                                    <span className="mx-2">&gt;</span>
                                    <span className="cursor-pointer">KPIs</span>
                                </p>
                                <h4 className="mt-1 text-2xl font-bold leading-tight text-white">Earnings Report</h4>
                            </div>
                    ...
                    <div className="w-full pb-10 bg-gray-200">
                        <div className="container px-6 mx-auto">
                            <div className="relative w-full">
                                <div className="absolute w-full -mt-20 h-auto md:h-20 bg-gray-800">
                                    <div className="md:hidden mt-8 -mb-1 bg-white w-full relative">
                                        ...
                                        <select aria-label="Selected tab" className="focus:outline-none form-select block w-full p-3 border-2 border-gray-300 rounded-b text-gray-600 appearance-none bg-transparent relative z-10">
                                            <option selected className="text-sm text-gray-600">
                                                Quarterly
                                            </option>
                                            <option className="text-sm text-gray-600">Yearly</option>
                                            <option className="text-sm text-gray-600">Historic Data</option>
                                            <option className="text-sm text-gray-600">Forecasting</option>
                                            <option className="text-sm text-gray-600">Comparison</option>
                                        </select>
                                    </div>
                                    <ul className="hidden md:flex flex-row h-full">
                                        <li className="border-l mt-6 rounded-t text-sm text-gray-800 px-10 py-4 bg-white">Quarterly</li>
                                        <li className="pt-10 pl-12 text-sm text-gray-300">Yearly</li>
                                        <li className="pt-10 pl-12 text-sm text-gray-300">Historic Data</li>
                                        <li className="pt-10 pl-12 text-sm text-gray-300">Forecasting</li>
                                        <li className="pt-10 pl-12 pb-0 text-sm text-gray-300">Comparison</li>
                                    </ul>
                                </div>
                                {/* Remove class [ h-64 ] when adding a card block */}
                                <div className="container mx-auto mb-10 bg-white h-64 shadow rounded-b">
                                    <div className="w-full h-full">{/* Place your content here */}</div>
                                </div>
                            </div>
                        </div>
                    </div>
