...
function Index() {
    ...
    return (
        <div>
            ...
            {/* Mobile */}
            {/* Navigation starts */}
            <nav className="w-full mx-auto bg-gray-800 z-30 relative">
            ...
            <div className="pt-8 pb-16 relative">
                ...
                <img className="z-10 w-full h-full absolute inset-0 object-cover" src="https://tuk-cdn.s3.amazonaws.com/assets/webapp/common/bg_image_dark.png" alt="bg" />
                ...
                <div className="z-10 relative container px-6 mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between">
                    ...
                    <div className="mt-6 lg:mt-0">
                        ...
                        <button className="focus:outline-none transition duration-150 ease-in-out hover:bg-gray-200 border bg-white rounded text-indigo-500 px-8 py-2 text-sm">Edit Profile</button>
                    </div>
                </div>
            </div>
            {/* Page title ends */}
            <div className="w-full bg-gray-200 pb-8">
                <div className="container px-6 mx-auto">
                    <div className="relative w-full">
                        {/* Remove class [ h-64 ] when adding a card block */}
                        <div className="mx-auto -mt-8 h-64">
