      ...
      <div className="relative">
        ...
        <nav className="z-20 relative w-full mx-auto shadow">
          <div className="container px-6 h-16 flex items-center justify-between mx-auto">
            <div className="flex items-center">
              <div className="rounded-full relative p-3 flex justify-end text-white">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="icon icon-tabler icon-tabler-search"
                  width={20}
            ...
            <ul className="flex items-start justify-center h-full">
              ...
              <li className="py-6 cursor-pointer font-bold xl:flex items-center text-sm text-gray-300 ml-0 xl:ml-10 tracking-normal hidden">
                Products
              </li>
              ...
              <li className="py-6 cursor-pointer font-bold xl:flex items-center text-sm text-gray-300 mr-10 tracking-normal hidden">
                Performance
              </li>
              <li className="py-6 cursor-pointer font-bold xl:flex items-center text-sm text-gray-300 tracking-normal hidden">
                Deliverables
              </li>
            </ul>
            <div
        ...
        <div className="container px-6 mx-auto">
          <div className="relative w-full">
            ...
            <div className="mx-auto -mt-8 h-64">
              <div className="bg-white shadow rounded w-full h-full">
