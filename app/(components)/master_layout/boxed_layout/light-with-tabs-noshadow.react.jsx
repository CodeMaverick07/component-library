        ...
        <div className="bg-indigo-100 w-full">
          <div className="container px-6 py-6 sm:py-0 mx-auto">
            ...
            <ul className="hidden sm:flex flex-row pt-8">
              <li className="rounded-t w-32 h-12 flex items-center justify-start pl-4 lg:pl-0 lg:justify-center bg-indigo-200 text-sm text-indigo-700">
                Dashboard
                <span className="ml-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li className="w-32 h-12 flex items-center pl-4 justify-center text-sm text-gray-800">
                Earnings
              </li>
              <li className="w-32 h-12 flex items-center pl-4 justify-center text-sm text-gray-800">
                Forecasting
