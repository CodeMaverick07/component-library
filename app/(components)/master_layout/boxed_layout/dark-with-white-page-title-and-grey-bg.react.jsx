      ...
      <div>
          ...
          <div className="container px-6 h-16 flex justify-between items-center xl:items-stretch mx-auto">
            <div className="flex items-center">
              ...
              <ul className="hidden xl:flex items-center h-full">
                <li className="cursor-pointer h-full flex items-center text-sm text-indigo-500 tracking-normal">
                  <span className="mr-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <li className="cursor-pointer h-full flex items-center text-sm text-white mx-10 tracking-normal">
                  <span className="mr-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <li className="cursor-pointer h-full flex items-center text-sm text-white mr-10 tracking-normal">
                  <span className="mr-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="w-full xl:w-auto h-full flex items-center justify-end">
              <div className="h-full flex">
                <div className="w-20 h-full hidden xl:flex items-center justify-center xl:border-l border-gray-700 text-gray-400">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="icon icon-tabler icon-tabler-search"
                    width={28}
                ...
                <div className="w-20 h-full hidden xl:flex items-center justify-center border-l border-r border-gray-700 text-gray-400">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="icon icon-tabler icon-tabler-messages"
                    width={28}
                ...
                <div className="w-20 h-full flex items-center justify-center xl:border-r border-gray-700">
                  <span className="w-6 h-6 xl:w-auto xl:h-auto text-gray-400">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="icon icon-tabler icon-tabler-bell"
                      width={28}
        ...
        <div className="my-6 lg:my-8 container px-6 mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between">
          ...
          <div className="mt-6 lg:mt-0">
            <button className="mx-2 my-2 bg-white transition duration-150 ease-in-out focus:outline-none hover:bg-gray-200 border border-gray-300 rounded text-indigo-700 px-6 py-2 text-sm">
              Back
            </button>
        ...
        <div className="w-full h-full py-12 bg-gray-200">
          ...
          <div className="container mx-auto px-6 h-64">
            ...
            <div className="flex w-full h-full flex-wrap rounded border-dashed border-2 border-gray-300">
