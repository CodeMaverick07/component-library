                ...
                <nav className="w-full mx-auto bg-white shadow relative z-20">
                    <div className="container px-6 h-16 flex items-center justify-between mx-auto">
                        ...
                        <ul className="flex items-center justify-center h-full">
                            <li className="cursor-pointer h-full hidden xl:flex items-center text-sm text-indigo-700 tracking-normal">Dashboard</li>
                            <li className="cursor-pointer h-full hidden xl:flex items-center text-sm text-gray-800 ml-10 tracking-normal">Products</li>
                            <li className="cursor-pointer mx-0 xl:mx-12">
                            ...
                            <li className="cursor-pointer h-full hidden xl:flex items-center text-sm text-gray-800 mr-10 tracking-normal">Performance</li>
                            <li className="cursor-pointer h-full hidden xl:flex items-center text-sm text-gray-800 tracking-normal">Deliverables</li>
                        </ul>
                        <div aria-haspopup="true" className="cursor-pointer h-full xl:flex hidden items-center justify-end relative">
                        ...
                        <div className="visible xl:hidden flex items-center relative">
                            ...
                            <svg aria-label="Main Menu" onClick={() => setShow(!show)} aria-haspopup="true" xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-menu" width={32} height={32} viewBox="0 0 24 24" strokeWidth="1.5" stroke="#2c3e50" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" />
                    ...
                    <div className="container px-6 mx-auto">
                        <div className="relative w-full">
                            ...
                            <div className="container mx-auto pb-10 h-64 -mt-8">
                                <div className="bg-white rounded shadow w-full h-full">{/* Place your content here */}</div>
                            </div>
                        </div>
                    </div>
                </div>
