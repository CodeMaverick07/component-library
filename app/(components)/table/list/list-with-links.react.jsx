...
const Index = (props) => {
  ...
  return (
    <div>
      <div class="mx-auto container pt-12 px-6">
        <div class="w-full overflow-x-scroll xl:overflow-x-hidden pb-24">
          <table class="min-w-full">
            <tbody>
              <tr class="h-20">
                <td class="w-6 pr-2">
                  <div class="flex dark:text-gray-100 text-gray-800 items-center">
                    <svg
                ...
                <td class="pl-6 pr-20">
                  <div class="flex items-center">
                    <img
                      src="https://cdn.tuk.dev/assets/components/todos/Bitmap.png"
                      alt="logo"
                      srcset=""
                    />
                    <div class="ml-4">
                      <h3 class="text-lg text-gray-800 dark:text-gray-100">
                        How to design a wireframe in Figma
                      </h3>
                      <h4 class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                ...
                <td class="relative w-5">
                  {show === 1 && (
                    <div class="dropdown-content mt-8 absolute left-0 -ml-24 shadow-md z-10  w-32">
                      <ul class="bg-white dark:bg-gray-800 shadow rounded py-1">
                        <li class="cursor-pointer text-gray-600 dark:text-gray-400 leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">
                          Edit
                        </li>
                        <li class="cursor-pointer text-gray-600 dark:text-gray-400 leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">
                          Delete
              ...
              <tr class="h-20">
                ...
                <td class="relative w-5">
                  ...
                  <button class="text-gray-500 dark:text-gray-400 rounded cursor-pointer border border-transparent focus:outline-none">
                    <svg
                      onClick={() => (show === 5 ? setshow(null) : setshow(5))}
                      xmlns="http://www.w3.org/2000/svg"
                      class="icon icon-tabler icon-tabler-dots dropbtn"
                      width="28"
                      height="28"
              ...
              <tr class="h-20">
                ...
                <td class="relative w-5">
                  ...
                  <button class="text-gray-500 dark:text-gray-400 rounded cursor-pointer border border-transparent focus:outline-none">
                    <svg
                      onClick={() => (show === 6 ? setshow(null) : setshow(6))}
                      xmlns="http://www.w3.org/2000/svg"
                      class="icon icon-tabler icon-tabler-dots dropbtn"
                      width="28"
                      height="28"
