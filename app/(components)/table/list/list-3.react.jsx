          ...
          <div>
            ...
            <div>
              ...
              <div className="bg-gray-100 rounded py-6 px-6">
                    ...
                    {show == 0 && (
                      <div className="dropdown-content mt-8 absolute  left-0 shadow-md z-10 w-32">
                        <ul className="bg-white shadow rounded py-1">
                          <li className="cursor-pointer text-gray-600 leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">
                            Edit
                          </li>
                          <li className="cursor-pointer text-gray-600 leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">
                            Delete
                ...
                <p className="text-sm leading-5 text-gray-600 mt-2 sm:w-11/12">
                  New comments are a great way to let your team know what they
                  you are upto and how far along the project has progressed. It
                  can also be valuable for someone that is looking for such
                  information so that they are not lost and know what needs to
                  be done next
                </p>
                <div className="flex items-center mt-5">
                  <img
                    className="w-8 h-8 rounded-full shadow"
                    src="https://cdn.tuk.dev/assets/templates/olympus/projects(15).png"
                  />
