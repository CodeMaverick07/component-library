          ...
          <table className="min-w-full bg-white dark:bg-gray-800">
            <thead>
              <tr className="w-full h-16 bg-gray-800 dark:bg-gray-200 py-8">
                ...
                <th className="text-gray-300 dark:text-gray-700 font-normal pr-6 text-left tracking-normal leading-4">
                  <div
                    className="bg-gray-800 dark:bg-gray-200 border rounded-sm border-gray-300 dark:border-gray-700 w-5 h-5 flex flex-shrink-0 justify-center items-center relative"
                    onClick={() => checkAll()}
                  >
                    <input
                      type="checkbox"
                ...
                <th
                  onclick="goToTodos()"
                  className="cursor-pointer text-gray-300 dark:text-gray-700 font-normal pr-6 text-left tracking-normal leading-4"
                >
                  Todos
                </th>
                <th className="cursor-pointer text-gray-300 dark:text-gray-700 font-normal pr-6 text-left tracking-normal leading-4">
                  Notes
                </th>
                <th className="cursor-pointer text-gray-300 dark:text-gray-700 font-normal pr-6 text-left tracking-normal leading-4">
                  Links
                ...
                <th className="rounded-r-lg text-gray-300 dark:text-gray-700 font-normal pr-8 text-left tracking-normal leading-4">
                  More
                </th>
              </tr>
            </thead>
            <tbody>
              <tr className="h-20 border-gray-300 dark:border-gray-700 border-b">
                ...
                <td className="text-sm pr-6 whitespace-no-wrap text-gray-800 dark:text-gray-100 tracking-normal leading-4 font-semibold">
                  08
                </td>
                <td className="text-sm pr-6 whitespace-no-wrap text-gray-800 dark:text-gray-100 tracking-normal leading-4 font-semibold">
                  03
