        ...
        <div className="mt-16 flex relative items-center justify-between text-gray-700">
          ...
          <div className="relative">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              className="cursor-pointer icon icon-tabler text-gray-900 dark:text-gray-100 icon-tabler-dots dropbtn"
              width={20}
              height={20}
              viewBox="0 0 24 24"
              strokeWidth="1.5"
          ...
          {show && (
            <div className="dropdown-content mt-8 absolute right-0 mt-36 shadow-md z-10  w-32">
              <ul className="bg-white dark:bg-gray-800 shadow rounded py-1">
                <li className="cursor-pointer text-gray-600 dark:text-gray-100 leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">
                  Edit
                </li>
                <li className="cursor-pointer text-gray-600 dark:text-gray-100 leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">
                  Delete
        ...
        <div className="mt-16 flex relative items-center justify-between text-gray-700">
          ...
          <div className="relative">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              className="cursor-pointer icon text-gray-900 dark:text-gray-100 icon-tabler icon-tabler-dots dropbtn"
              width={20}
              height={20}
              viewBox="0 0 24 24"
              strokeWidth="1.5"
