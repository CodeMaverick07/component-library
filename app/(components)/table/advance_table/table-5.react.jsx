          ...
          <tr className>
            ...
            <th className="flex items-end justify-end rounded-tr-lg">
              <button
                ...
                className="rounded-tr-lg py-5 px-4 hover:bg-indigo-600 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:outline-none bg-indigo-700 flex items-center"
              >
                <svg
                  width={24}
                  height={24}
                ...
                <p className="text-sm font-medium leading-none text-white pl-2">
                  Add Column
                </p>
              </button>
            </th>
