                  ...
                  <table className="w-full">
                    ...
                    <tbody className="w-full target-body2">
                      ...
                      <tr className="text-center text-gray-800">
                        <td>
                          <p className="py-1 bg-indigo-700 rounded-tl-full rounded-bl-full text-white">
                            3
                          </p>
                        </td>
                        <td>
                          <p className="py-1 bg-indigo-700 text-white -mx-1">
                            4
                          </p>
                        </td>
                        <td>
                        ...
                        <td>
                          <p className="py-1 bg-indigo-700 rounded-tr-full rounded-br-full text-white">
                            7
                          </p>
                        </td>
                        <td>
                    ...
                    <div className="flex flex-col items-center w-full">
                      ...
                      <div className="flex flex-wrap items-center justify-center mt-4 -ml-2 w-full">
                        <div className="m-2 flex items-center">
                          ...
                          <p className="text-sm leading-none text-gray-900 ml-2">
                            Day
                          </p>
                        </div>
                        <div className="m-2 flex items-center">
