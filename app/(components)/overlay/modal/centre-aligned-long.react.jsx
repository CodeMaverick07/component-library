        ...
        {show && (
          ...
          >
            <div className="relative py-8 px-8 md:px-16 bg-white dark:bg-gray-800 dark:border-gray-700 shadow-md rounded border border-gray-400">
              ...
              <p className="mb-3 text-sm text-gray-600 dark:text-gray-400 text-center font-normal">
                Are you sure you want to archive this project? Note that by
                clicking the archive project, this project will be disable
                across all Unity services and the data, files and information
                associated with it may become irrecoverable.
              </p>
              <p className="mb-5 text-sm text-gray-600 dark:text-gray-400 text-center font-normal">
                Type Archive Project to confirm this action. For more details
                click here
              </p>
