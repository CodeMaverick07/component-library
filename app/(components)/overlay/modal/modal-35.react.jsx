  ...
  return (
    <>
      <div className="py-8">
        <div
          role="alert"
          className="container mx-auto flex justify-center w-80 sm:w-9/12 md:w-2/3 xl:w-1/2 px-4"
        >
          <div className=" relative bg-white dark:bg-gray-800 w-full shadow rounded-md">
            <div className="sm:flex  items-stretch">
              <img
                className="w-full h-72 sm:h-auto  object-cover object-center sm:w-auto rounded-tl rounded-tr sm:rounded-tr-none sm:rounded-bl"
              ...
              <div className="w-full">
                <div className="px-6 w-full pt-8">
                  ...
                  <p className="text-sm leading-4 text-gray-600 mt-4 mb-5 dark:text-gray-300">
                  ...
                  <div className="flex items-center justify-between mt-4">
                    <p className="text-xs font-medium leading-3 text-gray-600 dark:text-gray-300 cursor-pointer">
                      Forgot Password?
                    </p>
                    <button className="focus:outline-none px-5 py-2 bg-indigo-700 dark:bg-indigo-600 rounded text-sm font-medium text-gray-100 hover:bg-opacity-80">
                      Login
                    </button>
                  </div>
                </div>
                <div className="mt-3.5 border-gray-200 dark:border-gray-700 border-t py-4 px-6">
                  <p className="text-xs leading-3 text-gray-600 dark:text-gray-300 cursor-pointer">
                    ...
                    <span className="text-indigo-700 dark:text-indigo-600 cursor-pointer font-semibold">
                      Register Here
                    </span>
                  </p>
                </div>
