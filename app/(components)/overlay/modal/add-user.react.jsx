...
function Index() {
  return (
    <div className="relative h-screen">
      <div
        id="popup"
        className="z-50 relative w-full flex justify-center inset-0"
      >
        <div
        ...
        <div className="mx-auto container">
          <div className="flex items-center justify-center h-full w-full">
            <div className="bg-white rounded-md shadow relative overflow-y-auto sm:h-auto w-10/12 md:w-8/12 lg:w-1/2 2xl:w-2/5">
