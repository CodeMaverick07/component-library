        ...
        >
          <div className="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
            ...
            <p className="mb-5 text-sm text-gray-600 font-normal">
              Are you sure you want to archive this project. If you confirm,
              after this you will be redirected to the project page.
            </p>
            <p className="mb-5 text-sm text-gray-600 font-normal">
              Check the action below for more details.
            </p>
