...
function MyApp() {
  return (
    <div className="h-[100vh] relative">
      <div
        className="w-full h-full bg-gray-900 bg-opacity-90 top-0 overflow-y-auto overflow-x-hidden sticky-0"
        id="chec-div"
      >
        <div
          ...
          <div className="xl:w-2/5 md:w-7/12 w-full absolute bg-gray-900 shadow h-full right-0">
            <div className="md:p-10 p-5">
              <div className="flex items-center justify-between">
                <p className="text-3xl font-bold leading-loose text-white">
                  Recent Updates
                </p>
                <div
                  role="button"
              ...
              <div>
                <p className="text-sm mt-6 leading-none text-white">
                  Hi William,
                </p>
                <p className="text-sm leading-5 mt-4 text-white md:pr-24">
                ...
                <p
                  ...
                  className="text-sm leading-none underline text-indigo-400 mt-8 cursor-pointer"
                >
            ...
            <div className="bg-gray-800 border-t border-b border-gray-700 w-full  md:p-10 p-5">
              <div className="flex items-center justify-between ">
                ...
                <p className="text-sm font-light leading-none text-white">
                  1 day ago
                </p>
              </div>
              <p className="text-sm leading-none text-white mt-6">
                Hi William,
              </p>
              <p className="text-sm leading-tight text-white md:pr-24 mt-4">
                Not to alarm you or anything but we noticed there has been
                drastic changes in your performance and thought you might want
                to have a look
              </p>
              <div className="pt-8">
                <div>
                ...
                <div
                  ...
                  className="flex items-center cursor-pointer mt-7"
                >
                  <p className="text-sm leading-none pr-0.5 underline text-indigo-400">
                    Go to my dashboard
                  </p>
                  <svg
                    width={16}
            ...
            <div className="px-10 py-4 bg-gray-900">
              <div className="flex items-center justify-between">
                <h1 className="text-xl font-medium mt-4 leading-5 text-white">
                  Getting Started
                </h1>
                <p className="text-sm leading-none text-white">30 mins ago</p>
              </div>
