...
const Index = () => {
  ...
  return (
    <div
      ...
      className={
        flag
          ? "xl:w-5/12 mx-auto sm:mx-0 relative sm:w-2/3 md:w-3/5 justify-between w-11/12 bg-white shadow-lg rounded flex sm:flex-row flex-col left-0 sm:left-auto dark:bg-gray-800 right-0 sm:top-0 sm:mr-6 mt-16 sm:mt-6 mb-6 sm:mb-0 transition duration-150 ease-in-out translate-show"
          : "translate-hide"
      }
    >
      <div>
        ...
        <div className="flex sm:flex-col flex-row sm:justify-center sm:border-l sm:items-center border-gray-300 dark:border-gray-700 sm:w-1/5 px-4 sm:px-0">
          <div className="py-4 sm:border-b border-gray-300 dark:border-gray-700 sm:w-full flex sm:justify-center mr-4 sm:mr-0 sm:px-4">
            <span className="sm:text-sm text-xs text-blue-500 font-bold cursor-pointer">
              Details
            </span>
          </div>
          <div
