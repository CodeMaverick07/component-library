    ...
    <div>
      ...
      >
        ...
        <div class="flex flex-col justify-center pl-4 sm:w-9/12 py-3">
          <p class="text-lg text-gray-800 dark:text-gray-100 font-semibold pb-1">
            Action Completed
          </p>
          <p class="text-sm text-gray-600 dark:text-gray-400 font-normal pb-2">
            Yuhuuu! You've got your $11.99 album from The Weeknd.
          </p>
          <div class="flex">
            <span class="text-sm text-green-400 font-bold mr-2 cursor-pointer">
              View{" "}
            </span>
            <span
              class="text-sm pl-2 text-gray-600 dark:text-gray-400 cursor-pointer"
