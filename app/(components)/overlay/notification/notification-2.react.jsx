    ...
    <>
      <div className="py-8 relative">
        <div className="flex items-end justify-end sm:mr-12 mr-6">
          ...
          <div
            role="alert"
            className="flex sm:items-center justify-between transition duration-150 ease-in-out bg-white dark:bg-gray-800 pl-3 pr-4  sm:pr-8 py-4 sm:py-0 shadow rounded shadow relative"
            id="notification"
          >
            <img
