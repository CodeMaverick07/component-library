...
const Index = () => {
  ...
  return (
    <div
      className={
        flag
          ? "xl:w-5/12 mx-auto sm:mx-0 sm:w-6/12 md:w-6/12 w-10/12 bg-white shadow-lg rounded flex pr-4 absolute left-0 sm:left-auto right-0 sm:top-0 sm:mr-6 mt-16 sm:mt-6 mb-6 dark:bg-gray-800 sm:mb-0 transition duration-150 ease-in-out translate-show"
          : "translate-hide"
      }
    >
      <div
      ...
      <div className="flex flex-col justify-center pl-4 py-4">
        ...
        <p className="text-xs text-gray-600 dark:text-gray-400 font-normal">
          You have successfully changed your password. If it's not you contact
          our team.
        </p>
      </div>
      <style>
