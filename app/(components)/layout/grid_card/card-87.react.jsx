        ...
        <div className="max-w-sm shadow">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-b sm:p-6 p-4">
            <div className="flex items-center">
              <div className="pr-5">
                <p className="w-8 text-sm font-semibold leading-none text-center text-gray-800 dark:text-gray-100">
                  THU
                </p>
                <p className="w-7 text-xl font-semibold leading-5 pt-1 text-center text-gray-800 dark:text-gray-100">
                  24
                </p>
              </div>
              ...
              <div className="pr-4">
                <div className="w-8 h-8 bg-gray-100 dark:bg-gray-700 rounded flex items-center justify-center">
                  <svg
                    ...
                    className="icon icon-tabler text-indigo-700 dark:text-indigo-600 icon-tabler-calendar"
                    width={20}
                    height={20}
                    viewBox="0 0 24 24"
                    strokeWidth="1.5"
            ...
            <div className="flex items-center pt-5">
              <div className="pr-4">
                <div className="w-8 h-8 bg-gray-100 dark:bg-gray-700 rounded flex items-center justify-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="icon icon-tabler text-indigo-700 dark:text-indigo-600 icon-tabler-map-pin"
                    width={20}
                    height={20}
                    viewBox="0 0 24 24"
                    strokeWidth="1.5"
            ...
            <div className="pt-8 flex items-center">
              <div className="w-9 h-9 bg-white shadow rounded-full flex items-center justify-center">
                <img
                  src="https://i.ibb.co/37n3fzs/1.png"
                  alt
              ...
              <div className="w-9 h-9 bg-white shadow rounded-full flex items-center justify-center -ml-2.5">
                <img
                  src="https://i.ibb.co/nDfs93B/2.png"
                  alt
                  className="w-8 h-8 rounded-full"
                />
              </div>
              <div className="w-9 h-9 bg-white shadow rounded-full flex items-center justify-center -ml-2.5">
                <img
                  src="https://i.ibb.co/qFfsngB/3.png"
                  alt
                  className="w-8 h-8 rounded-full"
                />
              </div>
              <div className="w-9 h-9 bg-white shadow rounded-full flex items-center justify-center -ml-2.5">
                <img
                  src="https://i.ibb.co/vj2rK3r/4.png"
                  alt
                  className="w-8 h-8 rounded-full"
                />
              </div>
              <div className="w-9 h-9 bg-white shadow rounded-full flex items-center justify-center -ml-2.5">
                <img
                  src="https://i.ibb.co/5By9D0H/5.png"
                  alt
                  className="w-8 h-8 rounded-full"
                />
              </div>
