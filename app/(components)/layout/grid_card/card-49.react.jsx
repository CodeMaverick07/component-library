          ...
          <div className="border-t border-gray-200 pt-12 pb-10">
            <div className="relative px-8">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <p className="text-4xl font-semibold leading-9 text-center text-indigo-700">
                  82%
                </p>
              </div>
            </div>
            <div className="px-6 pt-6">
              <p className="text-base leading-snug text-center text-gray-900 dark:text-gray-400">
                ...
                <span className="text-indigo-700">57</span> completed this
                month. Keep goinng!
              </p>
              <div className="flex flex-col  sm:flex-row justify-center mt-6 w-full">
                <button className="w-full sm:w-auto flex items-center mr-3 justify-center px-8 py-3 bg-gray-100 hover:bg-gray-200 rounded text-sm font-semibold leading-4 text-center text-indigo-700">
                  My Goals
                </button>
                <button className="w-full sm:w-auto mt-4 sm:mt-0 flex items-center justify-center px-8 py-3 bg-indigo-700 hover:bg-indigo-600 rounded text-sm font-semibold leading-4 text-center text-white">
                  + Add new
                </button>
              </div>
            </div>
