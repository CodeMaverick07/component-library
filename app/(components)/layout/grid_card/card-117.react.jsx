      ...
      <div className="flex flex-wrap items-center  sm:justify-start justify-center gap-7 py-20 sm:px-6 px-4">
        ...
        <div className="w-64 p-4 bg-blue-50 rounded">
          <div className="flex items-center justify-between">
            <h1 className="text-sm font-semibold leading-none text-gray-800">
              BTC
            </h1>
          ...
          <p className="text-sm leading-none mt-1 text-gray-800">
            Bitcoin to USD
          </p>
          ...
          <p className="text-xl font-semibold leading-5 mt-12 text-gray-800">
            $90,747
          </p>
          <p className="text-sm leading-none text-gray-800 mt-1">
            20% profit generated
          </p>
        </div>
