        ...
        <div className="max-w-xs sm:max-w-sm w-full bg-white pt-6 dark:bg-gray-800 rounded">
          <div className="pl-8 pr-6">
            <div className="flex items-center justify-between">
              <p className="text-2xl font-semibold leading-normal pr-10 sm:pr-32 text-gray-800 dark:text-gray-100">
                $256.45
              </p>
              <div className="w-24 h-6">
                <div className="flex items-center justify-center px-2 py-1.5 flex-1 h-full bg-indigo-700 rounded-md">
                  <p className="text-xs font-semibold leading-3 text-right text-white">
                    Planned 30%
                  </p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between pt-2">
              <p className="text-xs font-medium leading-3 pl-1 text-green-700">
                $5.30 (2.40%)
              </p>
              <p className="text-xs font-medium leading-3 text-right text-gray-500 dark:text-gray-400">
                28 days ago
              </p>
            </div>
            <div className="flex items-center justify-between pt-8 pb-2 border-b border-gray-200">
              ...
              <p className="text-sm leading-none text-right text-gray-800 dark:text-gray-100">
                $22.0k
              </p>
            </div>
