    ...
    <>
      ...
      <div className="flex items-center justify-center w-full h-full py-12 px-4">
        <div className="max-w-sm bg-white shadow-md pt-6 dark:bg-gray-800 rounded">
          <p className="text-xl font-semibold leading-5 pl-8 sm:pr-40 pr-10 text-gray-800 dark:text-gray-100">
            Last 7 day sales
          </p>
          <hr className="w-full border-gray-200 mt-4 mb-8" />
          <div className="pl-8">
            <p className="sm:text-3xl text-2xl font-semibold leading-7 text-gray-800 dark:text-gray-100">
              1,969
            </p>
            <p className="sm:text-base text-sm font-medium leading-4 pt-2 text-gray-500 dark:text-gray-400">
              Items Sold
            </p>
            <p className="sm:text-3xl text-2xl font-semibold leading-7 pt-6 text-gray-800 dark:text-gray-100">
              $ 15,467
            </p>
            <p className="sm:text-base text-sm font-medium leading-4 pt-2 text-gray-500 dark:text-gray-400">
              Total Earnings
