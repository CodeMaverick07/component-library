        ...
        <div className="md:w-96 w-80 bg-white dark:bg-gray-800 rounded py-4 px-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <p className="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-100 pr-3">
                Visitors
              </p>
              <svg
              ...
              >
                <path
                  d="M4 2V18H20V20H2V2H4ZM19.293 5.293L20.707 6.707L15 12.414L12 9.415L7.707 13.707L6.293 12.293L12 6.586L15 9.585L19.293 5.293Z"
                  fill="currentColor"
                />
                <path
            ...
            <div className="flex items-center">
              <div className="flex items-center pr-4">
                <div className="w-3 h-3 bg-gradient-to-br from-red-300 to-purple-500 rounded-full" />
                <p className="text-xs font-semibold leading-3 dark:text-gray-100 text-gray-800 pl-1">
                  new
                </p>
              </div>
              <div className="flex items-center">
                <div className="w-3 h-3 bg-gradient-to-tl from-yellow-300 to-red-400 rounded-full" />
                <p className="text-xs pl-1 font-semibold leading-3 dark:text-gray-100 text-gray-800">
                  returning
                </p>
              </div>
            </div>
