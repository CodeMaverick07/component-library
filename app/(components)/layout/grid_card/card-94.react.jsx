              ...
              <div className="md:flex">
                <div className="md:w-3/4 py-6 md:pr-7">
                  <div className="md:flex items-center">
                    <p className="text-xl font-semibold leading-5 md:pr-48 dark:text-gray-100 text-gray-800">
                      Revenue Report
                    </p>
                    <div className="flex items-center md:pt-0 pt-4">
                      <div className="flex items-center">
                        <div className="w-3 h-3 bg-indigo-700 rounded-full" />
                        <p className="text-sm leading-none text-gray-500 dark:text-gray-400 pl-2">
                          Earning
                        </p>
                      </div>
                      <div className="flex items-center pl-5">
                        <div className="w-3 h-3 bg-yellow-400 rounded-full" />
                        <p className="text-sm leading-none pl-2 text-gray-500 dark:text-gray-400">
                          Expense
                        </p>
                      </div>
                    </div>
                ...
                <div className="md:border-l md:py-6 py-4 border-gray-200 md:w-1/4 h-full flex items-center flex-col">
                  ...
                  <p className="text-2xl font-medium leading-normal pt-10 text-center dark:text-gray-100 text-gray-800">
                    $25,852
                  </p>
                  <p className="text-sm leading-none text-center pt-3 text-gray-500 dark:text-gray-400">
                    Budget: 56,800
                  </p>
                  <div className="px-11 pt-8">
                    <canvas id="myChart" width={130} />
                  </div>
                  <button className="text-sm mt-12 mb-6 font-medium leading-none text-center text-white py-2.5 px-5 rounded bg-indigo-700 hover:bg-indigo-600">
                    Increase Budget
                  </button>
                </div>
              </div>
