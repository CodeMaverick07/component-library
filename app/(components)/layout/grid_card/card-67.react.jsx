      ...
      <div className="flex items-center justify-center w-full h-full py-12 px-4">
        <div className="max-w-sm w-full bg-white pt-6 dark:bg-gray-800 rounded">
          <div className="pl-8 pr-6">
            <div className="flex items-center justify-between">
              ...
              <div className="w-8 h-6">
                <div className="flex items-center justify-center px-1 py-1.5 flex-1 h-full bg-green-100 rounded">
                  <p className="text-xs font-semibold leading-3 text-right text-green-700">
                    30%
                  </p>
                </div>
              </div>
            ...
            <p className="text-xs font-medium leading-3 pt-1 text-indigo-700">
              Task pending
            </p>
            <div className="flex items-start justify-between pt-7">
              <div className="flex items-start">
                ...
                <div className="flex flex-col pl-3">
                  ...
                  <p className="text-sm font-medium pt-1 leading-none text-gray-500 dark:text-gray-400">
                    Assigned tasks
                  </p>
                </div>
              </div>
              <p className="text-xl font-semibold leading-5 text-right text-gray-800 dark:text-gray-100">
                74
              </p>
            </div>
