...
export default function IndexPage() {
  useEffect(() => {
    ...
    window.onload = function () {
      ...
      window.myDoughnut = Chart(ctx, config);
    };
  });
  return (
    <>
        ...
        <div className="max-w-sm rounded shadow bg-white dark:bg-gray-800 px-6 py-5">
          <div className="sm:flex items-center">
            <div>
              ...
              <p className="text-xs leading-3 text-gray-500 dark:text-gray-400 pt-4 pb-1">
                This Month
              </p>
              <p className="text-base font-medium leading-none text-gray-800 dark:text-gray-100">
                $4055.56
              </p>
              <p className="w-44 text-xs leading-none text-gray-500 pt-5 dark:text-gray-400">
            ...
            <div className=" sm:mt-0 mt-5 relative flex items-center jutsify-center">
              ...
              <div className="absolute flex items-center justify-center flex-col inset-0">
                ...
                <p className="text-xs font-medium leading-3  text-gray-500 dark:text-gray-400">
                  Sales
                </p>
              </div>
            </div>
