      ...
      <div className="flex items-center justify-center w-full h-full py-12 px-4">
        <div className="max-w-3xl w-full bg-white shadow-md  dark:bg-gray-800 shadow rounded px-6 py-8">
          <div className="flex bg-gray-100 py-6 rounded items-center justify-between px-10 sm:px-14 mb-7">
            ...
            <p className="text-2xl font-medium leading-6 text-center text-gray-800 dark:text-gray-100">
              May 2020
            </p>
            <svg
              className="cursor-pointer"
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr className="text-2xl font-medium w-full leading-normal text-center text-gray-800">
                  ...
                  <td className="text-white bg-gradient-to-tl from-yellow-300 to-red-400 rounded-tl-lg rounded-bl-lg">
                    2
                  </td>
                  <td className="text-white bg-gradient-to-tr from-yellow-300 to-red-400">
                    3
                  </td>
                  <td className="text-white bg-gradient-to-tl from-yellow-300 to-red-400 rounded-tr-lg rounded-br-lg">
                    4
                  </td>
                  <td>5</td>
                  <td>6</td>
                ...
                <tr className="text-2xl font-medium leading-normal text-center text-gray-800">
                  ...
                  <td>16</td>
                  <td className="bg-gradient-to-tr from-indigo-400 to-purple-500 text-white rounded-tl-lg rounded-bl-lg">
                    17
                  </td>
                  <td className="bg-gradient-to-tl from-indigo-400 to-purple-500 text-white ">
                    18
                  </td>
                  <td className="bg-gradient-to-tr from-indigo-400 to-purple-500 text-white ">
                    19
                  </td>
                  <td className="bg-gradient-to-tl from-indigo-400 to-purple-500 text-white rounded-tr-lg rounded-br-lg">
                    20
                  </td>
