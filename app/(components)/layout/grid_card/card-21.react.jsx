      ...
      <div className="flex items-center justify-center px-4 py-8">
        <div className="bg-white dark:bg-gray-800 md:w-96 w-full rounded px-5 pt-4 pb-8 shadow">
          <div className="flex items-center justify-between">
            <p className="text-lg font-bold leading-5 text-gray-800 dark:text-gray-100">
              Customer Tickets
            </p>
            <p className="text-xs leading-3 text-right text-red-500">
              2.3% increase
            </p>
          </div>
          <div className="flex items-end justify-between mt-6">
            ...
            <button className="dark:bg-gray-700 bg-gray-100 rounded py-2 px-2 hover:bg-gray-200">
              <p className="text-xs leading-3 dark:text-gray-100 text-indigo-700">
                Resolve
              </p>
            </button>
          </div>
