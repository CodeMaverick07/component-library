    ...
    <>
      ...
      <div className="flex items-center justify-center w-full h-full py-8 px-4">
        <div className="md:w-96 w-80 bg-white dark:bg-gray-800 rounded py-4 px-8">
          <p className="text-base font-medium leading-4 text-gray-600 dark:text-gray-400">
          ...
          <div className="h-full w-full mt-14 relative flex items-center justify-center">
            ...
            <div className="absolute flex flex-col items-center jutsify-center">
              <p className="md:text-4xl text-2xl font-semibold leading-9 text-center text-gray-800 dark:text-gray-100">
                $159.89
              </p>
              <p className="text-sm leading-none text-center text-gray-500 dark:text-gray-100 pt-2">
                Total Earning
              </p>
            </div>
          </div>
