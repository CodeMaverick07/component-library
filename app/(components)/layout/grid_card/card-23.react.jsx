            ...
            <div className="md:flex items-center pt-5">
              ...
              <div className="pl-8 md:mt-0 mt-4">
                <div className="flex items-center">
                  ...
                  <h1 className="dark:text-white text-indigo-900 text-xs leading-3 md:pl-1 pl-2 font-normal">
                    Employees: 13%
                  </h1>
                </div>
                <div className="flex items-center py-4">
                  <div className="w-3 h-3 rounded-full bg-indigo-700" />
                  <h1 className="dark:text-white text-indigo-700 text-xs leading-3 md:pl-1 pl-2 font-normal">
                    Customers: 24%
                  </h1>
                </div>
                <div className="flex items-center">
                  <div className="w-3 h-3 rounded-full bg-indigo-500" />
                  <h1 className="dark:text-white text-indigo-500 text-xs leading-3 md:pl-1 pl-2 font-normal">
                    Vendors: 13%
                  </h1>
                </div>
              </div>
