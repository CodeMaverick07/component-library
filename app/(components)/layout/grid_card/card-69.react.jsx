        ...
        <div className="max-w-xs sm:max-w-sm w-full bg-white shadow-md  dark:bg-gray-800 rounded">
          <div className="p-4">
            <div className="flex items-center justify-between">
              <div className="flex flex-col sm:pr-56 pr-10">
                ...
                <p className="text-xs font-semibold leading-3 pt-1 text-gray-500 dark:text-gray-100">
                  USD
                </p>
              </div>
              <svg
            ...
            <p className="text-xs leading-3 text-gray-800 dark:text-gray-100 pt-6">
              Balance
            </p>
            <p className="sm:text-3xl text-2xl font-semibold pt-1 leading-7 text-gray-800 dark:text-gray-100">
              $964.45
            </p>
          </div>
          <div>
          ...
          <div className="p-4 flex items-center">
            <div className="flex items-center">
              ...
              <p className="text-xs font-semibold leading-3 pl-2 text-gray-800 dark:text-gray-100">
                3455.30
              </p>
            </div>
            <div className="flex items-center pl-4">
              ...
              >
                <path
                  d="M4.5 0V10.0312L1.10938 6.64062L0.390625 7.35938L4.64062 11.6094L5 11.9531L5.35938 11.6094L9.60938 7.35938L8.89062 6.64062L5.5 10.0312V0H4.5Z"
                  fill="#B91C1C"
                />
              </svg>
              <p className="text-xs font-semibold leading-3 pl-2 text-gray-800 dark:text-gray-100">
