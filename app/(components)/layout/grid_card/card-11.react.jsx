      ...
      <div className="flex items-center justify-center py-8 px-4">
        <div className="md:w-96 rounded shadow-lg py-4 px-5 dark:bg-gray-800 bg-white">
            ...
            >
              ...
              {show && (
                <ul className="dark:bg-gray-800 bg-white shadow rounded z-40 py-1 w-32 -ml-24 left-0 mt-8  absolute  top-0">
                  <li className="cursor-pointer text-gray-600 dark:text-gray-100 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">
                    Landing Pages
                  </li>
                  <li className="cursor-pointer text-gray-600 dark:text-gray-100 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">
                    Templates
          ...
          <p className="pt-4 text-xs leading-4 text-gray-600">
            Quia odit qui officiis molestiae. Ut qui fugit labore ut. Sed vel
            quam sit. Rerum molestiae ut doloribus nostrum et.
          </p>
          <p className="text-xs font-medium leading-3 pt-5 text-indigo-700">
            CONNECTIONS
          </p>
          ...
          <div className="flex items-end justify-end">
            <button className="text-xs font-medium leading-3 text-white py-3 px-4 rounded bg-indigo-700 focus:outline-none hover:opacity-90">
              Send a message
            </button>
          </div>
        </div>
