  ...
  return (
    <>
      <div className="flex items-center justify-center py-8">
        <div className="max-w-sm rounded bg-white dark:bg-gray-800 shadow sm:py-8 py-4 sm:px-6 px-4">
          <div className="flex items-center">
            <p className="text-lg font-semibold leading-4 text-gray-800 dark:text-gray-100 sm:pr-44 pr-28">
              Transactions
            </p>
            <div className="cursor-pointer relative">
              <svg
                ...
                className="icon icon-tabler icon-tabler-dots-vertical text-gray-500 dark:text-gray-400"
                width={20}
                height={20}
                viewBox="0 0 24 24"
                strokeWidth="1.5"
              ...
              {show && (
                <ul className="-ml-10 mt-1  bg-gray-200 rounded shadow-xl absolute">
                  <li className="cursor-pointer text-gray-600 text-xs leading-3 tracking-normal py-2 hover:bg-indigo-700 hover:text-white px-3 font-normal">
                    Edit
                  </li>
                  <li className="cursor-pointer text-gray-600 text-xs leading-3 tracking-normal py-2 hover:bg-indigo-700 hover:text-white px-3 font-normal">
                    Add
          ...
          <div className="pt-9">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div className="pl-2">
                  ...
                  <p className="text-xs leading-3 pt-3 text-gray-500 dark:text-gray-400">
                    Starbucks
                  </p>
                </div>
              </div>
              <p className="text-sm font-semibold leading-none text-right text-red-600 dark:text-red-400">
                - $74
              </p>
            </div>
            <div className="flex items-center justify-between pt-5">
              ...
              <p className="text-sm font-semibold leading-none text-right text-green-700 dark:text-green-400">
                + $480
              </p>
            </div>
            <div className="flex items-center justify-between pt-5">
            ...
            <div className="flex items-center justify-between pt-5">
                ...
                <div className="w-10 h-10 bg-purple-100 rounded flex items-center justify-center">
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M17.5 2.5H2.5C1.08333 2.5 0 3.58333 0 5V15C0 16.4167 1.08333 17.5 2.5 17.5H17.5C18.9167 17.5 20 16.4167 20 15V5C20 3.58333 18.9167 2.5 17.5 2.5ZM2.5 4.16667H17.5C18 4.16667 18.3333 4.5 18.3333 5V7.5H1.66667V5C1.66667 4.5 2 4.16667 2.5 4.16667ZM2.5 15.8333H17.5C18 15.8333 18.3333 15.5 18.3333 15V9.16667H1.66667V15C1.66667 15.5 2 15.8333 2.5 15.8333Z"
                      fill="#6D28D9"
                    />
                  </svg>
                </div>
              ...
              <p className="text-sm font-semibold leading-none text-right text-red-600 dark:text-red-600">
                - $23
              </p>
            </div>
            <div className="flex items-center justify-between pt-5">
