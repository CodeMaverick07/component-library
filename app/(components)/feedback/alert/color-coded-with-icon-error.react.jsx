    ...
    <div className="dark:bg-gray-900">
      ...
      <div className="flex items-center justify-center px-4 sm:px-0">
        <div
          ...
          className={
            flag
              ? "lg:w-10/12 transition duration-150 ease-in-out bg-red-200 shadow rounded-md  md:flex justify-between items-center  top-0 mt-12 mb-8 py-4 px-4"
              : " lg:w-10/12 transition duration-150 ease-in-out bg-red-200 shadow rounded-md  md:flex justify-between items-center  top-0 mt-12 mb-8 py-4 px-4 translate-hide"
          }
        >
          <div className="sm:flex items-center">
            ...
            <p className="text-base text-red-500">
              A problem has occurred while submitting your data. Please try
              again later
            </p>
          </div>
          <div className="flex justify-end mt-4 md:mt-0 md:pl-4 lg:pl-0">
            <span className="text-sm mr-4 font-bold cursor-pointer text-red-500">
              Details
            </span>
            <span
